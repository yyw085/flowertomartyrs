...
public class UserinfoController extends GeneralController<Userinfo>{
	...
	@Override
	@RequestMapping("add")
	public Object add(@RequestBody Userinfo model) throws Exception {
	...
	public Object update(@RequestBody Userinfo model) throws Exception {
